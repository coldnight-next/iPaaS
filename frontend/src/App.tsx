      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        {activeTab === 'connections' && (
          <div style={{ padding: '24px 0' }}>
            {!session && (
              <Card title="Sign in to manage connections" style={{ marginBottom: '16px' }}>
                <p>Use your Supabase account credentials to continue.</p>
                <div style={{ marginBottom: '16px' }}>
                  <Button
                    type="default"
                    block
                    icon={<img src="https://developers.google.com/identity/images/g-logo.png" alt="Google" style={{ width: '18px', height: '18px', marginRight: '8px' }} />}
                  ...
                  <div style={{ textAlign: 'center', margin: '16px 0', color: '#d9d9d9' }}>
                    ────── or ──────
                  </div>
                </div>
                <Form onFinish={handleAuthSubmit} style={{ marginTop: '16px' }}>
                  ...
                  {authError && (
                    <Alert message={authError} type="error" style={{ marginBottom: '16px' }} />
                  )}
                  <Space>
                    ...
                    >
                      {authMode === 'signIn' ? 'Need an account? Create one' : 'Already registered? Sign in'}
                    </Button>
                  </Space>
                </Form>
              </Card>
